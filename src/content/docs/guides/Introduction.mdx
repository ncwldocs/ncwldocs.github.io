...
Proceed to the nearest **Union Armory**. The Ministry of Defense forbids hoarding; all gear is **communal property of the Homeguard**. Standard loadout recommendations are as follows:
...
You are to report to the nearest **Briefing Site**, commonly located in cargo bays or auxiliary command halls. If such a site is not active, report the failure of protocol to the **Rear Observation Post** via secure channels. Lapses in coordination are to be logged and remediated.
