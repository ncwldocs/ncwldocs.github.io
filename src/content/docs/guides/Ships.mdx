...
<ShipWeapon weaponID="ShuttleGunExhumer" num="1" />
...
Turrets can rotate to follow targets. **If turrets are armed, they will automatically fire on any ship belonging to a hostile faction.** These weapons can be fired using the **Targeting Computer** by clicking a position in space to fire at; any selected turrets capable of firing in that direction will fire.
