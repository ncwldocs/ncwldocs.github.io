...
<Tabs>
  ...
  <TabItem label="Guide" icon="open-book">
    ...
    - Move all consoles and communications equipment into the rear engine room. Then, remove the tables and chair from the front room and replace with reinforced walls.
  </TabItem>
